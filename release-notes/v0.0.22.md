...
- Add explicit language selection to rank tracking, so you can override a country's default language. The picker lists only the languages the search-data provider supports for the selected country. — thanks @Devamol10
