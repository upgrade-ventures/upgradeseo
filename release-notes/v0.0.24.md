...
- A wrong or mis-formatted the search-data provider API key now shows a clear message telling you how to fix it, instead of "an unexpected error occurred". — thanks @mattmacrocket
