...
- Connect Google Search Console in self-hosted UpgradeSEO with your own Google OAuth client.
- Use the new Search Console MCP tools for performance data and URL inspection from your own GSC account.

## Improved

- Temporary the search-data provider 5xx errors now get quick retries and a clearer "temporarily unavailable" message.
