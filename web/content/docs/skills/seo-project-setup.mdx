...
- Recommend the next UpgradeSEO Agent Skill to run.
...
Set up [UpgradeSEO MCP](/docs/mcp) so your agent can confirm the right UpgradeSEO project and use live SEO data in later workflows.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Project Setup skill]()
