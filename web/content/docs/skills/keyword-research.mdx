...
- Ask before saving keywords back to UpgradeSEO.
...
- Confirm before saving selected keywords to UpgradeSEO.

## Use it with UpgradeSEO MCP

Set up [UpgradeSEO MCP](/docs/mcp) so your agent can research live keyword metrics, inspect Google SERPs, check saved keywords, and save selected terms with your approval.
