...
- Help you choose the next UpgradeSEO Agent Skill based on your goal.
- Distinguish strategy questions from execution work.
- Explain when to use UpgradeSEO MCP, web search, browser review, or local files.
...
- "What does UpgradeSEO help my agent do?"
...
The coach can help before MCP is connected, but your agent needs [UpgradeSEO MCP](/docs/mcp) for live keyword, SERP, domain, backlink, and saved keyword data.
